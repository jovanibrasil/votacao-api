...
public class Sessao {
  ...
  /**
   * Faz a verificação se a sessão está aberta. A duração da sessão é dada em horas e a contagem é feita
   * a partir de um horário de inicio. Uma sessão está aberta se o hora atual é anterior ao horário
   * de termino da sessão.
   * 
   * @return
   */
